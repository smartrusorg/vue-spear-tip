export default interface IHammer {
  new(element: HTMLElement|SVGElement, options?: HammerOptions): IHammerManager
...
interface HammerOptions {
  ...
  enable?: boolean|((manager: IHammerManager) => boolean)|undefined
...
interface HammerManagerConstructor {
  new(element: EventTarget, options?: HammerOptions): IHammerManager
}
...
type HammerEventsString = HammerEvents
 |`${HammerEvents} ${HammerEvents}`
 |`${HammerEvents} ${HammerEvents} ${HammerEvents}`

export interface IHammerManager {
  readonly element: HTMLElement|SVGElement
  add(recogniser: Recognizer): Recognizer
  add(recogniser: Recognizer): IHammerManager
  add(recogniser: Recognizer[]): Recognizer
  add(recogniser: Recognizer[]): IHammerManager
  destroy(): void
  ...
  remove(recogniser: Recognizer): IHammerManager
  remove(recogniser: string): IHammerManager
  set(options: HammerOptions): IHammerManager
  stop(force: boolean): void
}

export declare class HammerInput {
  constructor(manager: IHammerManager, callback: Function)
...
declare class TouchAction {
  constructor(manager: IHammerManager, value: string)
